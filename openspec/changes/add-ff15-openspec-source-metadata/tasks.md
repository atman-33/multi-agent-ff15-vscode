...
- [ ] 1.2 Preserve config `version` metadata without rejecting future version values.
...
- [ ] 3.2 Add/extend tests for flexible version handling, missing project profile errors, and source metadata behavior.
