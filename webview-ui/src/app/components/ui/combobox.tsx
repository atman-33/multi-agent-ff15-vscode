		...
		<ComboboxPrimitive.Portal>
			...
			>
				<ComboboxPrimitive.Popup
					className={cn(
						"group/combobox-content relative overflow-hidden rounded-md bg-popover text-popover-foreground shadow-md ring-1 ring-foreground/10 duration-100",
						"max-h-96 w-(--anchor-width) min-w-[calc(var(--anchor-width)+--spacing(7))] max-w-(--available-width) origin-(--transform-origin)",
...
function ComboboxChips({
	...
	return (
		<ComboboxPrimitive.Chips
			className={cn(
				"flex min-h-9 flex-wrap items-center gap-1.5 rounded-md border border-input bg-transparent bg-clip-padding px-2.5 py-1.5 text-sm shadow-xs transition-[color,box-shadow]",
